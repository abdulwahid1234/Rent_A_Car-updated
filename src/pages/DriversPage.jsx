  ...
  return (
    <div className="drivers-container">
      ...
      <div className="driver-controls">
        <div className="search-wrap">
          ...
          <input
            type="text"
            className="input"
            placeholder="Search name, CNIC, mobile, address…"
            value={search}
        ...
        {filteredDrivers.map((driver) => (
          <div key={driver.id} className="driver-card">
            ...
            <div className="driver-details">
              <p>
                <span>CNIC:</span> {driver.cnic}
              </p>
              <p>
                <span>Mobile:</span> {driver.mobile}
              </p>
              <p>
                <span>License:</span> {driver.license}
              </p>
              <p>
                <span>Status:</span>
                <span
                  className={`status ${driver.status.toLowerCase().replace(" ", "-")}`}
                >
                  {driver.status}
                </span>
              </p>
      ...
      {filteredDrivers.length === 0 && (
        <div className="empty-state card">No drivers match your search.</div>
      )}
